...
! efp_opts_t *efp_opts_create(void);
function efp_opts_create() bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: efp_opts_create
end function

! void efp_opts_free(struct efp_opts *opts);
subroutine efp_opts_free(opts) bind(c)
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: opts
end subroutine

! void efp_opts_set_terms(struct efp_opts *opts, unsigned value);
subroutine efp_opts_set_terms(opts, value) bind(c)
...
function efp_opts_get_terms(opts) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: efp_opts_get_terms
  type(c_ptr), value :: opts
end function

! void efp_opts_set_disp_damp(struct efp_opts *opts, int value);
subroutine efp_opts_set_disp_damp(opts, value) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: opts
  integer(c_int), value :: value
end subroutine
...
function efp_opts_get_disp_damp(opts) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: efp_opts_get_disp_damp
  type(c_ptr), value :: opts
end function

! void efp_opts_set_elec_damp(struct efp_opts *opts, int value);
subroutine efp_opts_set_elec_damp(opts, value) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: opts
  integer(c_int), value :: value
end subroutine
...
function efp_opts_get_elec_damp(opts) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: efp_opts_get_elec_damp
  type(c_ptr), value :: opts
end function

! void efp_opts_set_pol_damp(struct efp_opts *opts, int value);
subroutine efp_opts_set_pol_damp(opts, value) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: opts
  integer(c_int), value :: value
end subroutine
...
function efp_opts_get_pol_damp(opts) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: efp_opts_get_pol_damp
  type(c_ptr), value :: opts
end function

! void efp_opts_set_pol_driver(struct efp_opts *opts, int value);
subroutine efp_opts_set_pol_driver(opts, value) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: opts
  integer(c_int), value :: value
end subroutine
...
function efp_opts_get_pol_driver(opts) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: efp_opts_get_pol_driver
  type(c_ptr), value :: opts
end function

! void efp_opts_set_enable_pbc(struct efp_opts *opts, int value);
subroutine efp_opts_set_enable_pbc(opts, value) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: opts
  integer(c_int), value :: value
end subroutine
...
function efp_opts_get_enable_pbc(opts) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: efp_opts_get_enable_pbc
  type(c_ptr), value :: opts
end function

! void efp_opts_set_enable_cutoff(struct efp_opts *opts, int value);
subroutine efp_opts_set_enable_cutoff(opts, value) bind(c)
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: opts
  integer(c_int), value :: value
end subroutine
...
function efp_opts_get_enable_cutoff(opts) bind(c)
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: efp_opts_get_enable_cutoff
  type(c_ptr), value :: opts
end function

! void efp_opts_set_swf_cutoff(struct efp_opts *opts, double value);
subroutine efp_opts_set_swf_cutoff(opts, value) bind(c)
...
function efp_opts_get_swf_cutoff(opts) bind(c)
  use iso_c_binding, only: c_double, c_ptr
  real(c_double) :: efp_opts_get_swf_cutoff
  type(c_ptr), value :: opts
end function
